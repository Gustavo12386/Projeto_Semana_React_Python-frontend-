...
import { Descricao, Valor, Foto, Informacoes, ItemLista, ListaStyled, Nome, ListaVazia } from "./Lista.style";
             ...
             <Foto src={professor.foto}></Foto>
               <Informacoes>
                 <Nome>{professor.nome}</Nome>
                   ...
                   <Button onClick={() => props.onSelect(professor)} sx={{width: '40%'}}>Marcar Aula com {professor.nome}</Button>
                </Informacoes>
            </ItemLista>
          ))}
         </ListaStyled>
